    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3 ml-5 vendorIcon balance"> <a class="nav-link sellerIcon" href="perlog.php"
          ><b class="vendor_balance"></b></a> </li>
          <li class="nav-item mt-2 ml-4">
            <div class="dropdown show">
              <a class="btn btn-secondary dropdown-button  profile-btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-user"></i>&nbsp;&nbsp;&nbsp;
                <?php echo $_SESSION["mailo"];?>
              </a>

              <div class="dropdown-menu proflie" aria-labelledby="dropdownMenuLink">
        ...
        <li class="nav-item ml-4 cartIcon"> <a class="nav-link" href="cart.php" data-abc="true"><i
  ...
  while($row10=mysqli_fetch_assoc($query10)){                                ?>
    <div class="col-md-3 mb-3">
      ...
      <div class="card">
        ...
        <img class="card-img-top img-fluid img1" src="<?php echo $row1['photo'];?>" width="400px" height="250px">
