...
session_start();
if(empty($_SESSION['oxo']))
{header('location:index.php');}
else if(!isset($_POST["search0"])){
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta2/css/all.min.css" integrity="sha512-YWzhKL2whUzgiheMoBFwW8CKV4qpHQAEuvilg9FAn5VJUDwKZZxkJNuGM4XkWuk94WCrrwslk8yWNGmY1EduTA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
  ...
  <title><?php echo $_SESSION['oxo'];?></title>
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <form class="form-inline mt-2" method="post" action="search.php"> <input class="form-control searchBar" type="text" placeholder="Search"  name="sear" required>
      ...
      <div class='shop_view_items newxo'>
          <p class='text-center shop-name mt-5 mb-4'> Shop &nbsp;<?php ?></p>
      <div class='row mb-5 no-gutter'>
      <?php
      if(isset($_POST["search0"])){
    $r=$_POST["sear"];
    $r=preg_replace("#[^0-9a-z]#i","",$r);
    $sq=$_SESSION['oxo'];
    $q=mysqli_query($connect,"SELECT * FROM item WHERE CONCAT(name,tag) LIKE '%$r%' AND shopid='$sq' ORDER BY id DESC");
    $cp=mysqli_num_rows($q);
    if($cp == 0){
        $output="There is No result";
        echo $output;
    }else{
      while($roow=mysqli_fetch_assoc($q)){?>
                    ...
                    <div class="col-9">
                      ...
                      <div class="col-3">  
                        <div class="actions mt-1">
                          <div class="cartbutton neurobutton"><a href="">
